<%@ Page Title="Nhà Đất Bán" Language="C#" MasterPageFile="~/Gdien.master"
    AutoEventWireup="true" CodeBehind="NhaDatBan.aspx.cs"
    Inherits="WebApplication1.NhaDatBan" %>
                ...
                <div class="col-md-4" style="margin-bottom:25px;">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <p><strong>Giá:</strong> <%# Eval("Gia") %>  </p>
